...
updates. Use the pinned standalone installer for the `0.2.1` release:

Linux or macOS:

```console
curl -fsSL https://github.com/storious/agulater/releases/download/v0.2.1/install.sh | sh
```

Windows PowerShell:

```powershell
irm https://github.com/storious/agulater/releases/download/v0.2.1/install.ps1 | iex
```
